...
$products = $productTable->getProductsByTitle();
...
<div id="rightnav">
	...
	<div class="product-list">
		<h2>Our Products</h2>
                <a class="pages" href="sortByTitles.php?page=<?php echo $prev; ?>">&lt;prev</a>
		&nbsp;|&nbsp;
		<a class="pages" href="sortByTitles.php?page=<?php echo $next; ?>">next&gt;</a>
